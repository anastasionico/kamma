...
function Title() {
    return <nav className={'svg'}>
        <a href="https://www.kammadata.com/" target={'_blank'}>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 578.32 103.54" className="svg-logo"><title>Kamma</title>
                <polygon
